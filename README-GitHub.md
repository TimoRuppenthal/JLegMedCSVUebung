...
* Create Repository via the following [URL](https://github.com/new)
  * Set repository name to JLegMedCSVUebung 
...
* On your local system execute the following commands in the project directory:
    ...
    git branch -M main
    git remote add origin https://github.com/shs-it/JLegMedCSVUebung.git
    ```
...
*   [mavenBuild.yml](https://github.com/shs-it/JLegMedCSVUebung.git/actions/workflows/mavenBuild.yml):
    *   __Description:__ Builds the project after each push
    *   __Started:__ Automatically and manually   

*   [newRelease.yml](https://github.com/shs-it/JLegMedCSVUebung.git/actions/workflows/newRelease.yml):
...
*   [autoMerge.yml](https://github.com/shs-it/JLegMedCSVUebung.git/actions/workflows/autoMerge.yml):
...
*   [dependabot.yml](https://github.com/shs-it/JLegMedCSVUebung.git/actions/workflows/dependabot.yml):
...
```shell
docker stack deploy --compose-file ./deploy/docker-compose.yml jlegmedcsvuebung
```
